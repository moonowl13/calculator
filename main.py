...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox1.addWidget(self.b_dot)
        ...
        self.hbox3.addWidget(self.b_add)
        self.hbox3.addWidget(self.b_sub)
        self.hbox4.addWidget(self.b_res)
        self.hbox4.addWidget(self.b_clear)
        self.hbox4.addWidget(self.b_backspace)
